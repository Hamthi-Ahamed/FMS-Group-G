...
public class AdminStudentsPage extends JFrame implements ActionListener {
    ...
    private static final String CURRENT_PAGE = "Students";
    ...
    public AdminStudentsPage(String adminUsername) {
        this.adminUsername=adminUsername==null ? "admin" : adminUsername;
        setTitle("Faculty Management System - Admin Students");
    ...
    private JPanel buildSidebarPanel() {
        ...
        styleNavButton(studentsNavButton, true);
    ...
    private JPanel buildContentPanel(){
        ...
        JLabel headingLabel=new JLabel("Students", SwingConstants.CENTER);
        ...
        String[] columnNames = {"DB ID","Full Name","Student ID","Degree","Email","Mobile Number"};
        tableModel = new DefaultTableModel(DBConnector.getAdminStudentRows(), columnNames) {
            @Override
    ...
    private void saveChanges() {
        ...
        if(success) {
            ...
            JOptionPane.showMessageDialog(this, "Student changes saved successfully.");
        } else{
    ...
    private void reloadRowsFromDatabase() {
        ...
        Object[][] rows = DBConnector.getAdminStudentRows();
        for(Object[] row : rows) {
    ...
    private boolean saveTableRowsToDatabase() {
        ...
        java.util.List<DBConnector.AdminStudentRecord> records = new java.util.ArrayList<>();
        for (int row=0; row < tableModel.getRowCount();row++) {
            records.add(new DBConnector.AdminStudentRecord(
        ...
        return DBConnector.saveAdminStudents(records, deletedIds);
    }
